...
// const styles = getComputedStyle( document.getElementById(window));
...
//  export function newEvent(day, start, duration, label, color) {
...
//  export function updateEvent(n_event, day, start, duration, label, color) {
